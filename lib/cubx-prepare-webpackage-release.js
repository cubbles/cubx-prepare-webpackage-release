...
(function () {
   ...
   * @private
   */
  WebpackageReleasePreparer.prototype._writeManifest = function (manifest) {
   ...
   * @private
   */
  WebpackageReleasePreparer.prototype._isValidReleaseVersion = function (version) {
    var pattern = /^(\d+)(\.[\d]+)*$/;
   ...
   * @private
   */
  WebpackageReleasePreparer.prototype._isValidDevVersion = function (version) {
   ...
   * @private
   */
  WebpackageReleasePreparer.prototype._determineReleaseVersion = function (currentVersion) {
   ...
   * @private
   */
  WebpackageReleasePreparer.prototype._determineNextDevVersion = function (currentVersion) {
